...
Run node --test tests/*.test.mjs. Node tests cover frozen reference
outputs for nonfiction, fiction and comprehensive summaries, word budgets, stale
reviews, spoiler refusal, portable startup, missing-parser diagnostics, modern
language tags, input rejection, bibliography exclusion and visible internal data.
Node.js runs the suite against recorded reference outputs; fixture provenance is in
