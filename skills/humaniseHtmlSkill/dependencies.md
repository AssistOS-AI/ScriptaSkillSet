...
The language comes from the HTML lang attribute or an explicit --language option.
Node.js Intl.Locale validates tag syntax and returns canonical casing and subtag
ordering. Use hyphenated tags such as ro-RO, en-US and zh-Hant-TW. ICU data ships
with the Node.js runtime; canonicalization follows that runtime's ICU version.
This checks locale syntax, not whether the prose matches the declared language.
