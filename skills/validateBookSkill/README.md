...
No humanisation, translation proofreading, summaries, metadata, font +/− tests or screenshots. The final human-readable artifact is `report.md`, supported by JSON evidence and correction logs.
